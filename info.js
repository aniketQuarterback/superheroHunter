window.onload = function () {
    ...
    // chracter details
    let url = `https://gateway.marvel.com:443/v1/public/characters/${id}?ts=1&apikey=0260152e5eda54f7c4032ab89fef5993&hash=eafafa37b96ef58d1a99317741e6b8a9`;
    fetch(url)
      .then((response) => {
    ...
    url = `https://gateway.marvel.com:443/v1/public/characters/${id}/comics?ts=1&apikey=0260152e5eda54f7c4032ab89fef5993&hash=eafafa37b96ef58d1a99317741e6b8a9`;
